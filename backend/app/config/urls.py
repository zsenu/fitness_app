...
from core.views     import RegisterView,             UserProfileView,            LoginView,                  LogoutView, TokenRefreshView, StatisticsView
...
urlpatterns = [
    ...
    path('api/health-logs/date/<str:date>/',          HealthLogByDateView.as_view(),        name = 'health-log-by-date'),
    ...
    path('api/food-logs/date/<str:date>/',            FoodLogByDateView.as_view(),          name = 'food-log-by-date'),
    ...
    path('api/muscle-groups/',                        MuscleGroupListView.as_view(),        name = 'muscle-group-list'),
    ...
    path('api/strength-trainings/date/<str:date>/',   StrengthTrainingByDateView.as_view(), name = 'strength-training-by-date'),
    ...
    path('api/cardio-trainings/date/<str:date>/',     CardioTrainingByDateView.as_view(),   name = 'cardio-training-by-date')
]
